...
app = FastAPI(title="G2P2C Agent API", lifespan=lifespan)
...
def predict_action(req: StateRequest):
    ...
    if not agent:
        raise HTTPException(status_code=500, detail="G2P2C agent not loaded.")
