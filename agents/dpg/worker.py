...
from agents.dpg.core import Memory, StateSpace, composite_reward
...
class Worker:
    ...
    def rollout(self, dpg, replay_memory):
        ...
        for n_steps in range(0, rollout_steps):
            policy_step, mu, sigma = dpg.get_action(self.cur_state, self.feat, worker_mode=self.worker_mode)
