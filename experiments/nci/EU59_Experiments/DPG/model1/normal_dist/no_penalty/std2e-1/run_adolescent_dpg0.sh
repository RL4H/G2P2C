...
python3 /scratch/sj53/dt9478/G2P2C/experiments/run_RL_agent.py --agent  dpg --folder_id  DPG/model1/normal_dist/no_penalty/std2e-1/DPG0_1 --patient_id 0 --return_type average --action_type exponential --device cuda --pi_lr 1e-4 --vf_lr 1e-3 --soft_tau 0.001 --noise_application 1 --noise_model normal_dist --mu_penalty 0 --noise_std 2e-1 --seed 1 --debug 0 &
python3 /scratch/sj53/dt9478/G2P2C/experiments/run_RL_agent.py --agent  dpg --folder_id  DPG/model1/normal_dist/no_penalty/std2e-1/DPG0_2 --patient_id 0 --return_type average --action_type exponential --device cuda --pi_lr 1e-4 --vf_lr 1e-3 --soft_tau 0.001 --noise_application 1 --noise_model normal_dist --mu_penalty 0 --noise_std 2e-1 --seed 2 --debug 0 &
python3 /scratch/sj53/dt9478/G2P2C/experiments/run_RL_agent.py --agent  dpg --folder_id  DPG/model1/normal_dist/no_penalty/std2e-1/DPG0_3 --patient_id 0 --return_type average --action_type exponential --device cuda --pi_lr 1e-4 --vf_lr 1e-3 --soft_tau 0.001 --noise_application 1 --noise_model normal_dist --mu_penalty 0 --noise_std 2e-1 --seed 3 --debug 0
wait
