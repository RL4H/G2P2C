...
def set_agent_parameters(args):
    ...
    if args.agent == 'g2p2c':
        ...
        # DMMS.R 디버그 모드 확인
        if getattr(args, 'sim', 'simglucose') == 'dmms' and getattr(args, 'dmms_debug_mode', False):
            print("INFO: Using DMMS.R debug hyperparameters for single scenario optimization")
